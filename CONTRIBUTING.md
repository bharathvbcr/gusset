...
1. **No Breaking Public Surface:** The C ABI boundary is strictly 15 exported functions (verified by `tests/exports_match.rs`), and the Go API is capped at 12 public entry points. Adding a function requires an entry in `DECISIONS.md`.
